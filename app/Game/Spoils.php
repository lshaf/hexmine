...
final class Spoils
{
    ...
    public const STOCK = [
        ...
        'chipped_fang' => ['name' => 'Chipped Fang', 'tier' => 0, 'palette' => 'stone', 'grade' => 1, 'npcPrice' => 1, 'description' => 'Snapped off in something harder than it was. Everybody on the rim has a jar of them.'],
        'cracked_horn' => ['name' => 'Cracked Horn', 'tier' => 0, 'palette' => 'stone', 'grade' => 2, 'npcPrice' => 1, 'description' => 'Split down the middle and no use to anybody. It still smells of the thing.'],
        'snapped_quill' => ['name' => 'Snapped Quill', 'tier' => 0, 'palette' => 'stone', 'grade' => 3, 'npcPrice' => 1, 'description' => 'Hollow, light, and sharp at the wrong end. Nothing will take it as a point.'],
