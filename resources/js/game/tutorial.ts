...
export const TUTORIAL: TutorialStep[] = [
  {
    ...
    body: 'You are standing in forest. Tap the hex under your prospector and start a trip — you work the ground you stand on, and wood only comes from forest.',
    event: 'mine_start',
    tab: 'map',
  },
  {
    title: 'Collect the wood',
    body: 'Trips run on a timer whether the app is open or not. When it finishes, collect what you cut.',
    event: 'collect',
    tab: 'map',
  },
  {
    title: 'Walk to the settlement',
    body: 'Nobody out here will buy your wood. Traders, workshops and processing lines all live at settlements — tap the nearest one on the map and travel there.',
    event: 'travel',
    tab: 'map',
  },
  {
    title: 'Sell it to the trader',
    body: 'The trader pays badly on purpose. Gold is for basic gear and nothing more — it never buys anything tradeable.',
    event: 'sell',
    tab: 'shop',
  },
  {
    title: 'Buy a Stone Axe',
    body: 'Your first tool. Basic gear is cheap, weak, and available to everyone.',
    event: 'buy',
    tab: 'shop',
  },
  {
  ...
  },
  {
    ...
    body: 'Travel back out to a forest hex and cut again. Same wood, same trip, a bigger pile — that is what the axe bought you.',
    event: 'collect',
    tab: 'map',
  },
  {
  ...
  {
    title: 'Craft a Wood Pickaxe',
    body: 'Crafted gear beats anything gold can buy. This is the ladder: gold tier, then crafted, then the rare tiers.',
    event: 'craft',
    tab: 'craft',
  },
  {
    title: 'Put the pickaxe to work',
    body: 'Run one more trip. Then decide what to sell and what to process — that decision never stops mattering.',
    event: 'collect',
    tab: 'map',
  },
]
