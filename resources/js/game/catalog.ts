...
export const ITEMS: ItemDef[] = [
  ...
  {
    key: 'stone_axe', name: 'Stone Axe', slot: 'axe', rarity: 'common', tradeable: false, attack: 3,
    palette: 'stone', goldPrice: 17, maxDurability: 40, station: 'village',
    description: 'A chipped edge lashed to a handle. Better than bare hands.',
  },
  {
    key: 'chipped_pick', name: 'Chipped Pick', slot: 'pickaxe', rarity: 'common', tradeable: false,
    attack: 3, palette: 'stone', goldPrice: 17, maxDurability: 40, station: 'village',
    description: 'Second-hand, and shorter than it started. Still bites ore.',
  },
  {
    key: 'crude_bow', name: 'Crude Bow', slot: 'bow', rarity: 'common', tradeable: false, attack: 3,
    palette: 'wood', goldPrice: 17, maxDurability: 40, station: 'village',
    description: 'Green stave, gut string. Close range or nothing.',
  },
  {
    key: 'stone_mallet', name: 'Stone Mallet', slot: 'hammer', rarity: 'common', tradeable: false,
    attack: 3, palette: 'stone', goldPrice: 17, maxDurability: 40, station: 'village',
    description: 'A rock on a stick. It still splits badlands shale.',
  },
  {
    key: 'bent_sickle', name: 'Bent Sickle', slot: 'sickle', rarity: 'common', tradeable: false,
    attack: 3, palette: 'fiber', goldPrice: 17, maxDurability: 40, station: 'village',
    description: 'Someone straightened it once. It did not take.',
  },
  {
    key: 'iron_hatchet', name: 'Iron Hatchet', slot: 'axe', rarity: 'uncommon', tradeable: false,
    attack: 6, palette: 'iron', maxDurability: 70, station: 'city',
    inputs: { iron_ore: 4, ingots: 3, planks: 2, heartknot: 2 },
    description: 'Plain iron on a plain haft. Reliable, unremarkable.',
  },
  {
    key: 'miners_pick', name: "Miner's Pick", slot: 'pickaxe', rarity: 'uncommon', tradeable: false,
    attack: 6, palette: 'iron', maxDurability: 70, station: 'city',
    inputs: { iron_ore: 4, ingots: 3, planks: 2, flux_salt: 2 },
    description: 'Guild pattern, and every seam in the range has met one.',
  },
  {
  ...
  },
  {
    ...
    attack: 6, palette: 'iron', maxDurability: 70, station: 'city',
    inputs: { iron_ore: 4, ingots: 3, cut_stone: 2, whetgrit: 2 },
    description: 'Heavy enough that the stone does most of the arguing.',
  },
  {
    key: 'steel_sickle', name: 'Steel Sickle', slot: 'sickle', rarity: 'uncommon', tradeable: false,
    attack: 6, palette: 'iron', maxDurability: 70, station: 'city',
    inputs: { iron_ore: 4, ingots: 3, cloth: 2, quench_reed: 2 },
  ...
  },
  {
    ...
    description: 'Keeps the weather off, and the pockets hold more than they look like they should.',
  },
  {
    key: 'hide_shoes', name: 'Hide Shoes', slot: 'boots', rarity: 'uncommon', tradeable: false,
    stat: 'travelSpeed', value: 0.04, attack: 0, defense: 2, palette: 'pelt',
    maxDurability: 50, station: 'city',
    inputs: { pelt: 4, leather: 3, cloth: 2, tar_seep: 2 },
  ...
  {
    key: 'hewn_axe', name: 'Hewn Axe', slot: 'axe', rarity: 'common', tradeable: false, attack: 4,
    palette: 'wood', station: 'village', maxDurability: 60,
    inputs: { wood: 6, planks: 2, heartknot: 2 },
    description: 'Your first real tool. It will not last, but it will teach.',
  },
  {
    key: 'wood_pickaxe', name: 'Wood Pickaxe', slot: 'pickaxe', rarity: 'common', tradeable: false,
    attack: 4, palette: 'wood', station: 'village', maxDurability: 60,
    inputs: { wood: 6, planks: 2, flux_salt: 2 },
    description: 'Wood against rock. It lasts exactly as long as you would expect.',
  },
  {
    key: 'shortbow', name: 'Shortbow', slot: 'bow', rarity: 'common', tradeable: false, attack: 4,
    palette: 'wood', station: 'village', maxDurability: 60,
    inputs: { wood: 6, cloth: 2, horn: 2 },
    description: 'Straight stave, woven string. Quiet, and quick to redraw.',
  },
  {
    key: 'stone_maul', name: 'Stone Maul', slot: 'hammer', rarity: 'common', tradeable: false,
    attack: 4, palette: 'stone', station: 'village', maxDurability: 60,
    inputs: { stone: 6, cut_stone: 2, whetgrit: 2 },
    description: 'Dressed head, seated cold. Stone breaks stone.',
  },
  {
    key: 'reed_sickle', name: 'Reed Sickle', slot: 'sickle', rarity: 'common', tradeable: false,
    attack: 4, palette: 'fiber', station: 'village', maxDurability: 60,
  ...
  {
    key: 'ironbound_axe', name: 'Ironbound Axe', slot: 'axe', rarity: 'uncommon', tradeable: false,
    attack: 8, palette: 'iron', station: 'city', maxDurability: 120,
    inputs: { hardwood: 6, beams: 3, ingots: 2, heartknot: 3 },
    description: 'Wedged head, banded eye. Fells clean and comes back out.',
  },
  {
    key: 'iron_pickaxe', name: 'Iron Pickaxe', slot: 'pickaxe', rarity: 'uncommon',
    tradeable: false, attack: 8, palette: 'iron', station: 'city', maxDurability: 120,
    inputs: { hematite: 6, steel_ingots: 3, planks: 2, flux_salt: 3 },
    description: 'Balanced head, seasoned haft. The workhorse tool.',
  },
  {
    key: 'sinew_longbow', name: 'Sinew Longbow', slot: 'bow', rarity: 'uncommon', tradeable: false,
    attack: 8, palette: 'pelt', station: 'city', maxDurability: 120,
    inputs: { thick_pelt: 6, boiled_leather: 3, cloth: 2, horn: 3 },
    description: 'Sinew-backed and heavy to draw. The herd never hears it.',
  },
  {
    key: 'banded_sledge', name: 'Banded Sledge', slot: 'hammer', rarity: 'uncommon',
    tradeable: false, attack: 8, palette: 'iron', station: 'city', maxDurability: 120,
  ...
  {
    key: 'toothed_sickle', name: 'Toothed Sickle', slot: 'sickle', rarity: 'uncommon',
    tradeable: false, attack: 8, palette: 'iron', station: 'city', maxDurability: 120,
  ...
  {
    key: 'reinforced_boots', name: 'Reinforced Boots', slot: 'boots', rarity: 'uncommon',
    tradeable: false,
    stat: 'travelSpeed', value: 0.05, attack: 0, defense: 2, palette: 'stone', station: 'city',
    maxDurability: 140,
  ...
  },
  {
    ...
    stat: 'processingSpeed', value: 0.03, attack: 1, defense: 0, palette: 'fiber',
    station: 'village', maxDurability: 90,
  ...
  {
    key: 'broadaxe', name: 'Broadaxe', slot: 'axe', rarity: 'rare', tradeable: false, attack: 10,
    palette: 'iron', station: 'capital', maxDurability: 160,
  ...
  },
  {
    ...
    attack: 10, palette: 'iron', station: 'capital', maxDurability: 160,
  ...
  {
    key: 'warbow', name: 'Warbow', slot: 'bow', rarity: 'rare', tradeable: false, attack: 10,
    palette: 'pelt', station: 'capital', maxDurability: 160,
  ...
  },
  {
    ...
    attack: 10, palette: 'stone', station: 'capital', maxDurability: 160,
  ...
  {
    key: 'threshing_scythe', name: 'Threshing Scythe', slot: 'sickle', rarity: 'rare',
    tradeable: false, attack: 10, palette: 'iron', station: 'capital', maxDurability: 160,
  ...
  },
  {
    ...
    stat: 'travelSpeed', value: 0.08, attack: 0, defense: 3, palette: 'pelt', station: 'capital',
    maxDurability: 160,
  ...
  {
    key: 'tanners_gloves', name: "Tanner's Gloves", slot: 'gloves', rarity: 'rare',
    tradeable: false,
    stat: 'processingSpeed', value: 0.08, attack: 3, defense: 1, palette: 'pelt',
    station: 'capital', maxDurability: 160,
  ...
  //    shard, so kitting out a second line means crossing the map, §4.
  {
    ...
    attack: 14, palette: 'wood', station: 'capital', maxDurability: 200,
  ...
  },
  {
    ...
    tradeable: true, attack: 14, palette: 'iron', station: 'capital', maxDurability: 200,
  ...
  },
  {
    ...
    attack: 14, palette: 'pelt', station: 'capital', maxDurability: 200,
  ...
  },
  {
    ...
    tradeable: true, attack: 14, palette: 'stone', station: 'capital', maxDurability: 200,
  ...
  },
  {
    ...
    tradeable: true, attack: 14, palette: 'fiber', station: 'capital', maxDurability: 200,
  ...
  },
  {
    ...
    stat: 'travelSpeed', value: 0.11, attack: 0, defense: 4, palette: 'pelt', station: 'capital',
    maxDurability: 190,
  ...
  },
  {
    ...
    tradeable: true,
    stat: 'processingSpeed', value: 0.11, attack: 4, defense: 1, palette: 'fiber',
    station: 'capital', maxDurability: 195,
