...
export const CRITTERS: Material[] = [
  ...
  { key: 'dustleveret', name: 'Dustleveret', tier: 1, source: 'hunt', palette: 'pelt', critter: true, npcPrice: 4, description: 'A hare the color of the ground, and no slower for it.' },
